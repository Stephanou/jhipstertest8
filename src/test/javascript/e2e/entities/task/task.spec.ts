...
describe('Task e2e test', () => {
  ...
  it('should load Tasks', async () => {
    ...
    expect(await taskComponentsPage.getTitle()).to.eq('jhipstertest8App.task.home.title');
  ...
  it('should load create Task page', async () => {
    ...
    expect(await taskUpdatePage.getPageTitle()).to.eq('jhipstertest8App.task.home.createOrEditLabel');
  ...
  it('should delete last Task', async () => {
    ...
    expect(await taskDeleteDialog.getDialogTitle()).to.eq('jhipstertest8App.task.delete.question');
